...
@section('content')
        ...
        <div class="panel panel-default">
               ...
               @if ($item->replies()->where('best_answer',1)->first())
                        <button class="btn btn-success btn-xs mx-auto" style="margin-right:10px">Closed Discussion</button>
               @else
                        <button class="btn btn-danger btn-xs mx-auto" style="margin-right:10px">Open Discussion</button>    
               @endif
