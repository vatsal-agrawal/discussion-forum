...
return [
    ...
    'providers' => [
        ...
        'github' => [
            'client_id' => '0a511eff942e850559bd',
            'client_secret' => '84111ef1d89d7c8e1147098e0ab576b89adb3bba',
            'redirect_uri' => 'http://localhost:8080/discussion-forum/public/github/redirect',
            'scope' => [],
        ],
        'linkedin' => [
            'client_id' => '12345678',
